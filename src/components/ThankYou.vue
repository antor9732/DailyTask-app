  ...
  >
    ...
    >
      <div class="d-flex flex-column align-items-center">
        ...
        <h2
          class="mb-2 fw-bold"
          style="color: #7c3aed; font-size: 1.7rem; letter-spacing: 0.5px"
        >
          Thank you for your update!
        </h2>
        <p class="mb-4" style="color: #6b7280; font-size: 1.08rem">
          Your daily update has been submitted successfully.
        </p>
      </div>
      <div
        class="d-flex flex-column flex-md-row gap-2 justify-content-center mt-2"
      >
        <button
          class="btn px-4 py-2 fw-semibold shadow-sm"
          style="background: #a78bfa; color: #fff; border-radius: 8px"
          @click="$router.push('/daily-update')"
        >
